...
<body class="register-page hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">

         <!-- Slideshow 4 -->
         <?php $this->load->view('frontend/'.$page_name.'.php'); ?>
      <!-- //banner -->
      <!-- //footer -->
  </div>
...
function set(obj,abc) {
  var aa = $(obj).attr('class');
  $('.'+abc).removeClass("worngans");
  $(obj).addClass("worngans");
}
</script>
...
$(document).ready(function(){
        ...
        qb.click(function()
        {
          qf.ajaxForm(
          {
              ...
              if(resp[0]==200)
              {
                 alertify.alert("",resp[1],function()
                 {
